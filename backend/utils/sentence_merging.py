...
grouped1, topic_labels1 = group_sentences("../../../files/networking1.pdf",contains_header= True,contains_footer=True,output_prefix="output1")
print(" Topic Labels from Document 1:", topic_labels1) 
print("Processing Document 2...")
grouped2, topic_labels2 = group_sentences("../../../files/networking1i.pdf",contains_header = True,contains_footer = True,output_prefix="output2")
print(" Topic Labels from Document 1:", topic_labels2) 
print(f"FROM FILE 2: {grouped2}")
